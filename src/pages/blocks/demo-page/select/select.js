    ...
    })
    {
        ...
        this.SetupListOptions = function() {
            ...
            for (var i = 0; i < x.length; i++) {
                ...
                // Append
                document.getElementById("ul_" + randomID).insertAdjacentHTML('beforeend', "<li class='" + is_disabled + " " + is_separator + "'  ><div class='select-text-wrap'> " + has_attachment + " <span> " + optionText + "</span></div></li>");
            }
        ...
        this.CriarDivBase = function() {
            ...
            if (!selected_option.attributes.multiple) {
                ...
                if (FoundSelectedOP == 1) {
                    first_option_text = '<div class="select-text-wrap"><img src=" '+ selected_option.options[selected_option.selectedIndex].getAttribute("data-img") + '"><span>' + selected_option.options[selected_option.selectedIndex].innerHTML + '</span></div>';
                } else {
